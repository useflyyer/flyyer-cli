...
@flayyer/cli/1.3.0 darwin-x64 node-v12.16.3
...
_See code: [src/commands/build.ts](https://github.com/flayyer/flayyer-cli/blob/v1.3.0/src/commands/build.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/flayyer/flayyer-cli/blob/v1.3.0/src/commands/deploy.ts)_
...
_See code: [src/commands/start.ts](https://github.com/flayyer/flayyer-cli/blob/v1.3.0/src/commands/start.ts)_
<!-- commandsstop -->
