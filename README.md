...
@flyyer/cli/3.0.0-beta.2 darwin-x64 node-v16.4.2
$ flyyer --help [COMMAND]
USAGE
  $ flyyer COMMAND
...
...
_See code: [src/commands/build.ts](https://github.com/useflyyer/flyyer-cli/blob/v3.0.0-beta.2/src/commands/build.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/useflyyer/flyyer-cli/blob/v3.0.0-beta.2/src/commands/deploy.ts)_
...
_See code: [src/commands/start.ts](https://github.com/useflyyer/flyyer-cli/blob/v3.0.0-beta.2/src/commands/start.ts)_
<!-- commandsstop -->
